...
<body>
    <div class="exam-container">
            ...
            <tbody>
                <c:forEach var="exam" items="${exams}">
                    <tr>
                        <td>${exam.idExam}</td>
                        <td>${exam.name}</td>
                        <td>${exam.speciality.idSpeciality}</td>
                        <td>
                            <a href="${pageContext.request.contextPath}/admin/examAdmin?action=edit&id=${exam.idExam}">Modifier</a>
                            <a href="${pageContext.request.contextPath}/admin/examAdmin?action=delete&id=${exam.idExam}" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet examen ?');">Supprimer</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
        ...
        <!-- Bouton pour ajouter un nouvel examen -->
        <a href="${pageContext.request.contextPath}/admin/examAdmin?action=add" class="button">add exam</a>
