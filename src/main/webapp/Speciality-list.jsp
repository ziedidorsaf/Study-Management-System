...
<body>
    <div class="speciality-container">
            ...
            <tbody>
                <c:forEach var="speciality" items="${specialities}">
                    <tr>
                        ...
                        <td>${speciality.nameS}</td>
                        <td>
                            <a href="${pageContext.request.contextPath}/admin/specialityAdmin?action=edit&id=${speciality.idSpeciality}">Modifier</a>
                            <a href="${pageContext.request.contextPath}/admin/specialityAdmin?action=delete&id=${speciality.idSpeciality}" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette spécialité ?');">Supprimer</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
        ...
        <a href="${pageContext.request.contextPath}/admin/specialityAdmin?action=add" class="button">add speciality</a>
